...
public:
   ...
   /*!
     ...
     */
    virtual bool loadData(IlwisObject*, const IOOptions& opt=IOOptions() ) { return false; }
    virtual bool dataIsLoaded() const { return false; }
    virtual bool store(IlwisObject *, const IOOptions&  ) { return false; }
    virtual bool storeData(IlwisObject *, const IOOptions& ) { return false; }
...
public:
    ...
    virtual void dataIsLoaded(bool ) {};
    /*!
