...
//TODO redesign in ther GSL connector
//namespace Ilwis {
//class KERNELSHARED_EXPORT IndexSlicer
//{
//public:
//    IndexSlicer(const IRasterCoverage& cov);
//    void grid(const IRasterCoverage& cov);
//    IRasterCoverage operator()(const QString& item1);
//private:
