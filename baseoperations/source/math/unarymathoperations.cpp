...
ArcTangentCoverage::ArcTangentCoverage(quint64 metaid,const Ilwis::OperationExpression& expr) : UnaryMathRasterAndNumber(metaid, expr, "value", arctan)
{}
...
EulerExpCoverage::EulerExpCoverage(quint64 metaid,const Ilwis::OperationExpression& expr) : UnaryMathRasterAndNumber(metaid, expr, "value", expEuler)
{}
...
ArcTangentTable::ArcTangentTable(quint64 metaid,const Ilwis::OperationExpression& expr) : UnaryMathTable(metaid, expr, "value", arctan)
{}
...
EulerExpTable::EulerExpTable(quint64 metaid,const Ilwis::OperationExpression& expr) : UnaryMathTable(metaid, expr, "value", expEuler)
{}
