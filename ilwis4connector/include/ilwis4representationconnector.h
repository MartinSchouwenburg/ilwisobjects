...
namespace Ilwis {
	namespace Ilwis4C {
		...
		class Ilwis4RepresentationConnector : public Ilwis4Connector
		{
		public:
			Ilwis4RepresentationConnector(const Ilwis::Resource &resource, bool load, const IOOptions& options = IOOptions());
